...
public class RxRetrofitForUserInfo {
    ...
    private static com.cat.miao.network.RxRetrofitForUserInfo utils=new com.cat.miao.network.RxRetrofitForUserInfo();
    UserInfoApi userInfoApi;

    public static com.cat.miao.network.RxRetrofitForUserInfo getInstens(){
        return utils;
    }
    ...
    public void getUserInfo(final com.cat.miao.network.RxRetrofitForUserInfo.CallBack call, String number){
    ...
    public void updateInfo(final com.cat.miao.network.RxRetrofitForUserInfo.UpdateCallBack call){
        //map转json
