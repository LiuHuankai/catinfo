...
public class RxRetrofitForCat {
    ...
    private static com.cat.miao.network.RxRetrofitForCat utils=new com.cat.miao.network.RxRetrofitForCat();
    CatApi catApi;

    public static com.cat.miao.network.RxRetrofitForCat getInstens(){
        return utils;
    }
    ...
    public void getEveryCat(final com.cat.miao.network.RxRetrofitForCat.CallBack call, int CatID){
